data "azurerm_key_vault_secret" "storage_account_access_key" {
  for_each     = { for k, v in var.linux_function_app_slots : k => v if v.storage_account_access_key_key_vault_id != null && v.storage_account_access_key_key_vault_secret_name != null }
